...
Holdout period starts 2026-05-01T00:00:00Z. No labelled bars exist at or after
this date in the current truth file (`btc_1h_v1.json`). Re-run this command
once the operator adds holdout labels.
...
def cmd_validate(args: argparse.Namespace) -> None:
    ...
    if len(labelled_holdout) == 0:
        ...
        rules_path = Path(args.output) / "rules.py" if hasattr(args, "output") else None
