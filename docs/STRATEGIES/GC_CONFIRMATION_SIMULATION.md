...
**Hard-block list:** ['long_double_bottom', 'long_multi_divergence', 'short_double_top']
...
| detect_long_rsi_momentum_ga   | long_rsi_momentum_ga   |      26 |         0   |           80.8 |        19.2 |         0 | False             |             0 |           26 |         100   |
...
| detect_short_mfi_multi_ga     | short_mfi_multi_ga     |       8 |        25   |           12.5 |        62.5 |         0 | False             |             0 |            8 |         100   |
...
- **Total emits across all detectors:** 999
- **Hard-blocked by GC (multi_divergence + double_top/bottom misaligned):** 42
- **Aligned (boosted):** ~137
- **Suppression rate:** 4.2% of all signals filtered out