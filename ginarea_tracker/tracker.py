        ...
        while not _stop.is_set():
            ...
            for bot in bots:
                ...
                storage.write_snapshot({
                    ...
                    "stat_updated_at": stat.get("statUpdatedAt", ""),
                })
                ...
                try:
                    ...
                    if state[bot_id].get("prev_params_hash") != params_hash:
                        storage.write_params({
                            ...
                            "grid_step": params.get("gridStep", ""),
                            "grid_step_ratio": params.get("gridStepRatio", ""),
                            "max_opened_orders": params.get("maxOpenedOrders", ""),
                            "border_top": params.get("borderTop", ""),
                            "border_bottom": params.get("borderBottom", ""),
                            "instop": params.get("instop", ""),
                            "minstop": params.get("minstop", ""),
                            "maxstop": params.get("maxstop", ""),
                            "target": params.get("target", ""),
                            "total_sl": params.get("totalSl", ""),
                            "total_tp": params.get("totalTp", ""),
